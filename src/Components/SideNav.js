...
import ExtendedSideNav from"./ExtendedSideNav.js";
...
class SideNav extends React.Component{
	...
	render(){
		return(
			...
			<nav className="side-navbar">
				...
				<div className="nav-item">
					<div className="nav-item-content">
						<svg id="new project menu" onClick={this.extendSideNav} viewBox="0 0 32 32"  fill="none"  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
				...
				<div className="nav-item" >
					<div className="nav-item-content">
						<svg id="export" onClick={this.extendSideNav} viewBox="0 0 32 32"  fill="none"  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
				...
				<div className="nav-item" >
					<div className="nav-item-content">
						<svg id="import menu" onClick={this.extendSideNav} viewBox="0 0 32 32" fill="none"  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
				...
				<div className="nav-item">
					<div className="nav-item-content">
						<svg id="add a new shape menu" onClick={this.extendSideNav} viewBox="0 0 32 32"  fill="none"  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
				...
				<div className="nav-item" >
					<div className="nav-item-content">
          	<svg id="transform menu" onClick={this.extendSideNav} viewBox="0 0 20 20"  fill="none"  strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25">
				...
				<div className="nav-item" >
					<div className="nav-item-content">
						<svg id="settings menu" onClick={this.extendSideNav} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"    strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
			...
			<nav className="extended-sidenavbar">
				{this.state.isSideNavExtended ? <ExtendedSideNav  /> : <></>}
			</nav>
			</>
		);
	}
