// set the action types to variables before importing them into the reducer files 
...
export const SET_ELLIPSE_Y = "SET_ELLIPSE_Y";
export const SET_ELLIPSE_X = "SET_ELLIPSE_X";
...
export const SET_CURRENT_SIDE_NAV_MENU_TYPE = "SET_CURRENT_SIDE_NAV_MENU_TYPE";
//🐣